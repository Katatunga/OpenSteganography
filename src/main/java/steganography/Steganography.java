...
public interface Steganography {
    /**
     * Encodes the given payload into the given carrier (image, mp3, ...) and returns the result.
    ...
    byte[] encode(byte[] carrier, byte[] payload)
            ...
            MediaReassemblingException, MediaCapacityException, EncoderException;
    ...
    byte[] decode(byte[] steganographicData)
            throws IOException, MediaNotFoundException, UnsupportedMediaTypeException, UnknownStegFormatException, DamagedMessageException, EncoderException;
    ...
    boolean isSteganographicData(byte[] data)
            throws IOException, MediaNotFoundException, UnsupportedMediaTypeException, DamagedMessageException, EncoderException;
